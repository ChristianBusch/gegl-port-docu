...
Man sieht, dass die Ausführungszeit von der Threadszahl abhängt. Deswegen soll die Threadszahl empirisch festgestellt werden. Erzielter Speedup: der bester Speedup im Vergleich zu der schnellsten GIMP MMX Version wurde mit 4 Threads erreicht und beträgt 1.13.
\begin{table}[H]
\centering
\begin{tabular}{lrrrrr}
\toprule
